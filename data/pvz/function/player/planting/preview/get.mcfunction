execute positioned ^ ^ ^0.2 if block ~ ~ ~ air if entity @p[tag=this.player,distance=..12] run return run function pvz:player/planting/preview/get
...
execute unless entity @n[tag=planting.preview,tag=this.preview] run function pvz:player/planting/preview/summon
