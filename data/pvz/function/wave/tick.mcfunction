...
execute if score @s wave.zombie_count matches 0 if score @s wave.time_last_wave matches ..0 run tellraw @s {text:"Round ended"}
execute if score @s wave.zombie_count matches 0 if score @s wave.time_last_wave matches ..0 run tag @s remove wave_active